...
public class LoginLogicClass {    
    ...
    public static int registerValidation(String user, String pass, String rePass, String email) {
        List<Users> res = DatabaseClass.selectQueryUsersLists();
        int errorIndicator = 0;
        Boolean validity = true; 
        for (Users u : res) {
            if (u.getEmail().equalsIgnoreCase(email)) {
                validity = false;
                errorIndicator = 4; // email already exists
            }
            if (u.getUsername().equalsIgnoreCase(user)) {
                validity = false;
                errorIndicator = 3; // username already taken
            }
        }
        if (!VALID_EMAIL_REGEX.matcher(email).matches()) {
            validity = false;
            errorIndicator = 1; //email is invalid
        }
        if (!pass.equals(rePass) || pass.isEmpty() || rePass.isEmpty()) {
            validity = false;
            errorIndicator = 2; //password is invalid
        }
    ...
    public static int editDataValidationAll(String user, String pass, String rePass, String email) {
        List<Users> res = DatabaseClass.selectQueryUsersLists();
        int errorIndicator = 0;
        Boolean validity = true; 
        for (Users u : res) {
    ...
    public static int editDataValidationUsername(String user, String pass, String rePass, String email) {
        List<Users> res = DatabaseClass.selectQueryUsersLists();
        int errorIndicator = 0;
        Boolean validity = true; 
        for (Users u : res) {
    ...
    public static int editDataValidationPassword(String user, String pass, String rePass) {
        List<Users> res = DatabaseClass.selectQueryUsersLists();
        int errorIndicator = 0;
        Boolean validity = true; 
        if (!pass.equals(rePass) || pass.isEmpty() || rePass.isEmpty()) {
    ...
    public static int editDataValidationEmail(String user, String pass, String rePass, String email) {
        List<Users> res = DatabaseClass.selectQueryUsersLists();
        int errorIndicator = 0;
        Boolean validity = true;
        for (Users u : res) {
